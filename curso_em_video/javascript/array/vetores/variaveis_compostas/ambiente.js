...
num.push(1)// esse método serve para adicionar um valor na ultima posição.

console.log(`Nosso vetor é o ${num} e temos ${num.length} elementos.`) //num.length é um atributo que serve para sabermos a quantidade de elementos que temos em nosso array.
